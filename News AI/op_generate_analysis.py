...
help_chart.create_bargraph_png_icon(top_10_volume_changer,'volume_change_pct','Top 10 Stocks by Volume Change (Compared to 5-day SMA)','Volume Change (%)','Volume_graph',40,-100)
