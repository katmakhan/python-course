...
help_chart.create_bargraph_png_icon(top_10_volume_changer,'volume_change_pct','Top 10 Stocks by Volume Change (Compared to 5-day SMA)','Volume Change (%)','Volume_graph',60,-100)
help_chart.create_bargraph_png_icon(top_10_price_changer,'price_change_pct','Top 10 Stocks by LTP Change (Compared to 10-day close)','Percent Change (%)','ltp_change_graph',10,-10)
help_chart.create_bargraph_png_icon(top_10_near_52weekhigh,"pcnt",'Top 10 Stocks by LTP Change (Compared to 52 week high)','Percent Change (%)','ltp_52weeknear_graph',2.5,2.5)